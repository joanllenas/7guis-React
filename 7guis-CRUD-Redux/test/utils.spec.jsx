...
describe('findUserIndexById', () => {
  it('finds the user', () => {
    const users = createUsersList();
    const userIndex = findUserIndexById(users, 'u2');
    expect(userIndex).toEqual(1);
  });

  it('returns -1 when the user is not found', () => {
    const users = createUsersList();
    const userIndex = findUserIndexById(users, 'u99999');
...
describe('filterUserByPrefix', () => {
  ...
  it('returns the whole array of users when passing an empty prefix', () => {
